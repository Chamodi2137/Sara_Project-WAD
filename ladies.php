...
$connect = mysqli_connect("localhost:3306","root","","shopdb");
...
<meta charset="utf-8">
<title>cart</title>
<link rel="stylesheet" href="ladiestyle.css">
</head>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="col-md-4">
						...
						<form method="post" action="ladies.php?id=<?=$row['id'] ?>">
					...
					if(!empty($_SESSION['cart'])){
						...
						foreach ($_SESSION['cart'] as $key => $value) {
							...
							$output .= "
							 <tr>
							  ...
							  <td>
							     <a href='ladies.php?action=remove&id=".$value['id']."'>
						...
						$output .="
						  <tr>
						   ...
						   <td>
						   		<a href='ladies.php?action=clearall'>
